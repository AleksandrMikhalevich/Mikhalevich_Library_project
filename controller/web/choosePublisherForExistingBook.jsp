...
<div style="text-align: center;">
    <h3>Добавление издательства к существующей книге</h3>
</div>
<div class="w-90 p-3" style="text-align: center;">
    <form name="choosePublisher" method="post" action="controller">
        <table class="table table-bordered table-hover" style="text-align: center;">
            ...
            <tbody>
            <c:forEach var="publisher" items="${sessionScope.changedPublishers}">
                <tr>
                    <td>
        ...
        <input name="action" type="hidden" value="update_chosen_publisher_for_existing_book">
